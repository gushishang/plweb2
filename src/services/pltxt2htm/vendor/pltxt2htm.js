...
async function pltxt2htm(moduleArg = {}) {
  var moduleRtn;
...
/** not-@type {!BigUint64Array} */
  ...
  function findWasmBinary() {
    if (Module["locateFile"]) {
      return locateFile("pltxt2htm.wasm");
    }

    // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
    return new URL("pltxt2htm.wasm", import.meta.url).href;
  }
  ...
  var _ver_major = (Module["_ver_major"] =
    makeInvalidEarlyAccess("_ver_major"));
  var _ver_minor = (Module["_ver_minor"] =
    makeInvalidEarlyAccess("_ver_minor"));
  var _ver_patch = (Module["_ver_patch"] =
    makeInvalidEarlyAccess("_ver_patch"));
  var _advanced_parser = (Module["_advanced_parser"] =
    makeInvalidEarlyAccess("_advanced_parser"));
  var _fixedadv_parser = (Module["_fixedadv_parser"] =
    makeInvalidEarlyAccess("_fixedadv_parser"));
  var _common_parser = (Module["_common_parser"] =
    makeInvalidEarlyAccess("_common_parser"));
  var _deallocate = (Module["_deallocate"] =
    makeInvalidEarlyAccess("_deallocate"));
  ...
  function assignWasmExports(wasmExports) {
    assert(
      typeof wasmExports["ver_major"] != "undefined",
      "missing Wasm export: ver_major",
    );
    assert(
      typeof wasmExports["ver_minor"] != "undefined",
      "missing Wasm export: ver_minor",
    );
    assert(
      typeof wasmExports["ver_patch"] != "undefined",
      "missing Wasm export: ver_patch",
    );
    assert(
      typeof wasmExports["advanced_parser"] != "undefined",
      "missing Wasm export: advanced_parser",
    );
    assert(
      typeof wasmExports["fixedadv_parser"] != "undefined",
      "missing Wasm export: fixedadv_parser",
    );
    assert(
      typeof wasmExports["common_parser"] != "undefined",
      "missing Wasm export: common_parser",
    );
    assert(
      typeof wasmExports["deallocate"] != "undefined",
      "missing Wasm export: deallocate",
    );
    assert(
    ...
    _ver_major = Module["_ver_major"] = createExportWrapper("ver_major", 0);
    _ver_minor = Module["_ver_minor"] = createExportWrapper("ver_minor", 0);
    _ver_patch = Module["_ver_patch"] = createExportWrapper("ver_patch", 0);
    _advanced_parser = Module["_advanced_parser"] = createExportWrapper(
      "advanced_parser",
      2,
    );
    _fixedadv_parser = Module["_fixedadv_parser"] = createExportWrapper(
      "fixedadv_parser",
      2,
    );
    _common_parser = Module["_common_parser"] = createExportWrapper(
      "common_parser",
      1,
    );
